...
class Orcamentos_FormConfiguracao extends Zend_Form {
    ...
    public function init() {
        ...
        $titulo_id->addMultiOptions($TextosModel->getByCategoria(1));
        ...
        $condicao_pagamento_id->addMultiOptions($TextosModel->getByCategoria(2));
        ...
        $prazo_entrega_id->addMultiOptions($TextosModel->getByCategoria(3));
        ...
        $observacao_id->addMultiOptions($TextosModel->getByCategoria(4));
