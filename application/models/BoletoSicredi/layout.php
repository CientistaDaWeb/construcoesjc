...
<html>
    <head>
        <title>Boleto Construções JC</title>
    ...
    <body text="#000000" bgColor="#ffffff" topMargin="0" rightMargin="0">
        ...
        if (!empty($boletos)):
            foreach ($boletos AS $boleto):
                require('BoletoSicredi/boleto.php');
                ?>
                        ...
                        <td valign="top" class="cp">
                            <div align="left">
                                ...
                                <ul>
                                    ...
                                    <li>Caso tenha problemas ao imprimir, copie a sequencia numérica abaixo e pague no caixa eletrônico ou no internet banking:<br><br></li>
                                </ul>
                                <span class="ld2">
                ...
                <table cellspacing="0" cellpadding="0" width="666" border="0">
                    <tbody>
                        ...
                        <tr>
                            <td class=ct width="666"><div align="right"><b class="cp">Recibodo Sacado</b></div></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table width="666" cellspacing="5" cellpadding="0" border="0" align="default">
                    <tr>
                        <td width=41><img src="/uploads/logos/<?php echo $boleto['logomarca']; ?>"></td>
                        <td class="ti" width="455"><?php echo $dadosboleto["identificacao"]; ?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? "<br>" . $dadosboleto["cpf_cnpj"] : '' ?><br><?php echo $dadosboleto["endereco"]; ?><br><?php echo $dadosboleto["cidade_uf"]; ?><br></td>
                ...
                <table cellspacing="0" cellpadding="0" width="666" border="0">
                    <tr>
                        <td class="cp" width="150"><span class="campo"><img src="/images/boletos/logosicredi.jpg" width="150" height="40" border="0"></span></td>
                        <td width=3 valign="bottom"><img height=22 src="/images/boletos/3.png" width="2" border="0"></td>
                        <td class="cp"t width=58 valign=bottom><div align=center><font class="bc"><?php echo $dadosboleto["codigo_banco_com_dv"] ?></font></div></td>
                        <td width=3 valign=bottom><img height=22 src="/images/boletos/3.png" width="2" border="0"></td>
                ...
                <table cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="cp" valign="top" width=7 height="12"><img height="12" src="/images/boletos/1.png" width=1 border="0"></td>
                            <td class="cp" valign="top"  width=34 height="12"><div align=left><span class="campo"><?php echo $dadosboleto["aceite"] ?></span></div>
                            </td><td class="cp" valign="top" width=7 height="12"><img height="12" src="/images/boletos/1.png" width=1 border="0"></td>
