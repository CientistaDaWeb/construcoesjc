...
class ContasPagar_Model extends WS_Model {
    ...
    public function adjustToForm($data) {
    ...
    public function buscarPorCategoria($dataInicial = '', $dataFinal = '') {
        $consulta = $this->_db->select()
                ->setIntegrityCheck(false)
    ...
    public function buscarAcumulado($data_inicial) {
        $consulta = $this->_db->select()
                ->setIntegrityCheck(false)
                ->from('contas_pagar', array('soma' => 'SUM(valor_pago)'))
    ...
    public function getSumByPeriod($dataInicial, $dataFinal, $conta_fixa, $ignore = NULL) {
        $sql = $this->_db->select()
                ->setIntegrityCheck(false)
    ...
    public function getSumByPeriodCategory($dataInicial, $dataFinal, $ignore = NULL) {
        $sql = $this->_db->select()
                ->setIntegrityCheck(false)
